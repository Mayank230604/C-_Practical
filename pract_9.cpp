...
// Main function
int main() {
    Person* person1 = new Person("Mike Lee");
    Person* student1 = new Student("Shawn Hame", "Computer Science", 90, 2022);
    Person* employee1 = new Employee("Bobby John", "Human Resources", 50000);
